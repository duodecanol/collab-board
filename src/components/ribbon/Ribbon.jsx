...
<div id="jam-bar-center-menu" class="jam-bar-menu jam-bar-center-menu">
            ...
            >
              ...
              <MenuList>
                <MenuItem>
                  ...
                  <Typography variant="body2" color="text.secondary">⌘ ER</Typography>
                </MenuItem>
                <MenuItem>
                  <ListItemIcon>
                ...
                <MenuItem>
                  ...
                  <Typography variant="body2" color="text.secondary">⌘ IM</Typography>
                </MenuItem>
                <MenuItem>
                  <ListItemIcon>
                  ...
                  <Typography variant="body2" color="text.secondary">⌘ Del</Typography>
                </MenuItem>
                <MenuItem>
                  <ListItemIcon>
    ...
    <AppBar position="static" sx={{  bgcolor: "#AAAAAA"   }}>
      <Toolbar sx={{ minHeight: 20 }} variant="dense">
            ...
            <Paper sx={{ width: 240, maxWidth: '100%' }}>
              <MenuList>
                ...
                <MenuItem>
                  ...
                  <Typography variant="body2" color="text.secondary">Ctrl+Alt+ [</Typography>
                </MenuItem>
                <MenuItem>
                  <ListItemIcon>
                    {}
                  ...
                  <Typography variant="body2" color="text.secondary">Ctrl+Alt+1</Typography>
                </MenuItem>
                <MenuItem>
                  <ListItemIcon>
                    {}
                  ...
                  <Typography variant="body2" color="text.secondary">Ctrl+Alt+2</Typography>
                </MenuItem>
                <MenuItem>
                  <ListItemIcon>
                    {}
                  ...
                  <Typography variant="body2" color="text.secondary">Ctrl+Alt+3</Typography>
                </MenuItem>
                <MenuItem>
                  <ListItemIcon>
                    {}
                  ...
                  <Typography variant="body2" color="text.secondary">Ctrl+Alt+4</Typography>
                </MenuItem>
                <Divider> zz</Divider>
                <MenuItem>
                  <ListItemIcon>
        ...
        <Box sx={{  flexGrow: 0 }}>
          <Button variant="primary"> <Typography>Set Background</Typography> </Button>
        </Box>

        <Divider orientation="vertical" flexItem sx={{  mx: 1, border: '1px solid' }}/>

        <Box sx={{  flexGrow: 0 }}>
          <Button variant="primary"> <Typography>Remove Frame</Typography> </Button>
        </Box>
      </Toolbar>
    </AppBar>
    </Box>
